            ...
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <div class="form-group">
                  <label>nom quizz</label>
                  <input class="form-control" placeholder="Enter text" name="nomquizz"><hr>
                  <label>nombre de question</label>
                  <input class="form-control" type="number" id="nbquest" name="nbquest" min="5" max="40">
                  <br><center><button type="submit" class="btn btn-default">Submit Button</button></center>
                </div>
            </form>
