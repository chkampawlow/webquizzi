...
$question1=$questionc->afficherquest($_GET["idq"]); 
    ...
    foreach($question as $row)
    {
      if (!empty($_GET[$row['idquest']]))
      {
        ...
        if( $x == $row['repv'])
        {
          ...
          {
            $error = "quizz unfinished";
            header ("Location: passquizz.php?idq=".$row['idquizz']);
          }
        }
    echo $score;
    ?>
...
<body>
  ...
  <main id="main">
    ...
    <section class="inner-page pt-4">
      <div class="container">
        <h3>
          votre note est <?php echo $score; ?> / <?php echo $_GET["nbrquest"] ?>
    </h3>
      </div>
    </section>
    ...
    <?php   
						 foreach($question1 as $row){         $x=  $_GET[$row['idquest']]; ?>
        ...
        {?><br><br><div class="card">
          ...
          <br><?php
          echo $row['quest'];?><br><br><?php echo $row['repv'];
          }					?>
            </div>
