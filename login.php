  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="main">
      ...
      <div class="container b-container" id="b-container">
        <form class="form" id="b-form" method="POST" action="authentification.php">
          ...
          <input class="form__input" type="text" placeholder="Email" name="mail">
          <input class="form__input" type="password" placeholder="Password" name="pass"><a class="form__link">Forgot your password?</a>
          <button class="form__button button submit">SIGNe IN</button>
        </form>
      </div>
